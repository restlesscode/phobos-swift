...
open class ChartDataSet: ChartBaseDataSet {
  ...
  @objc override open var yMin: Double { _yMin }

  /// The maximum y-value this DataSet holds
  @objc override open var yMax: Double { _yMax }

  /// The minimum x-value this DataSet holds
  @objc override open var xMin: Double { _xMin }

  /// The maximum x-value this DataSet holds
  @objc override open var xMax: Double { _xMax }
