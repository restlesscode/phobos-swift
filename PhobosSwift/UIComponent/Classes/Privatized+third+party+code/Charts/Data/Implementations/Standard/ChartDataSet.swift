...
open class ChartDataSet: ChartBaseDataSet {
  ...
  @objc
  open var values: [ChartDataEntry] { entries }
  ...
  override open func entryForXValue(_ xValue: Double,
  ...
  override open func entryIndex(x xValue: Double,
                                closestToY yValue: Double,
