...
open class YAxis: AxisBase {
  ...
  @objc open var isInverted: Bool { inverted }
  ...
  @objc open var isDrawBottomYLabelEntryEnabled: Bool { drawBottomYLabelEntryEnabled }

  @objc open var isDrawTopYLabelEntryEnabled: Bool { drawTopYLabelEntryEnabled }
}
