...
open class AxisBase: ComponentBase {
  ...
  @objc open var centerAxisLabelsEnabled: Bool {
    get { _centerAxisLabelsEnabled && entryCount > 0 }
    set { _centerAxisLabelsEnabled = newValue }
  }

  @objc open var isCenterAxisLabelsEnabled: Bool { centerAxisLabelsEnabled }
  ...
  @objc open var entryCount: Int { entries.count }
  ...
  @objc open var isDrawGridLinesEnabled: Bool { drawGridLinesEnabled }

  @objc open var isDrawAxisLineEnabled: Bool { drawAxisLineEnabled }

  @objc open var isDrawLabelsEnabled: Bool { drawLabelsEnabled }

  /// Are the LimitLines drawn behind the data or in front of the data?
  ///
  /// **default**: false
  @objc open var isDrawLimitLinesBehindDataEnabled: Bool { drawLimitLinesBehindDataEnabled }

  /// Are the grid lines drawn behind the data or in front of the data?
  ///
  /// **default**: true
  @objc open var isDrawGridLinesBehindDataEnabled: Bool { drawGridLinesBehindDataEnabled }
  ...
  @objc open var isForceLabelsEnabled: Bool { forceLabelsEnabled }
  ...
  @objc open var isAxisMinCustom: Bool { _customAxisMin }
  ...
  @objc open var isAxisMaxCustom: Bool { _customAxisMax }
