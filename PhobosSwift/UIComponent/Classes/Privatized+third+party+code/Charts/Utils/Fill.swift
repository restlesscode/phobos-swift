...
open class Fill: NSObject {
  ...
  @objc public init(radialGradient: CGGradient,
  ...
  @objc open class func fillWithLinearGradient(_ linearGradient: CGGradient,
                                               angle: CGFloat) -> Fill
  {
    Fill(linearGradient: linearGradient, angle: angle)
  }

  @objc open class func fillWithRadialGradient(_ radialGradient: CGGradient,
                                               startOffsetPercent: CGPoint,
                                               startRadiusPercent: CGFloat,
                                               endOffsetPercent: CGPoint,
                                               endRadiusPercent: CGFloat) -> Fill
  {
  ...
  @objc open func fillPath(context: CGContext,
                           rect: CGRect)
  {
    let fillType = _type
    if fillType == .empty {
