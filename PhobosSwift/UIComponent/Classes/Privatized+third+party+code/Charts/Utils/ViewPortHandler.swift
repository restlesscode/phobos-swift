...
open class ViewPortHandler: NSObject {
  ...
  @objc open var offsetRight: CGFloat {
    chartWidth - contentRect.size.width - contentRect.origin.x
  }
  ...
  @objc open var offsetBottom: CGFloat {
    chartHeight - contentRect.size.height - contentRect.origin.y
  }
  ...
  @objc open var contentCenter: CGPoint {
    CGPoint(x: contentRect.origin.x + contentRect.size.width / 2.0, y: contentRect.origin.y + contentRect.size.height / 2.0)
  }
  ...
  @objc open var hasNoDragOffset: Bool {
    transOffsetX <= 0.0 && transOffsetY <= 0.0
  }
