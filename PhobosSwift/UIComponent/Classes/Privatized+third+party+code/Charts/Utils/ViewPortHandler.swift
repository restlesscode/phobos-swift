...
open class ViewPortHandler: NSObject {
  ...
  @objc open var offsetRight: CGFloat {
    _chartWidth - _contentRect.size.width - _contentRect.origin.x
  }
  ...
  @objc open var offsetBottom: CGFloat {
    _chartHeight - _contentRect.size.height - _contentRect.origin.y
  }
  ...
  @objc open var contentRight: CGFloat {
    _contentRect.origin.x + _contentRect.size.width
  }

  @objc open var contentBottom: CGFloat {
    _contentRect.origin.y + _contentRect.size.height
  }
  ...
  @objc open var contentCenter: CGPoint {
    CGPoint(x: _contentRect.origin.x + _contentRect.size.width / 2.0, y: _contentRect.origin.y + _contentRect.size.height / 2.0)
  }
  ...
  @objc open func zoom(scaleX: CGFloat, scaleY: CGFloat) -> CGAffineTransform {
    _touchMatrix.scaledBy(x: scaleX, y: scaleY)
  }
  ...
  @objc open func zoomIn(x: CGFloat, y: CGFloat) -> CGAffineTransform {
    zoom(scaleX: 1.4, scaleY: 1.4, x: x, y: y)
  }
  ...
  @objc open func zoomOut(x: CGFloat, y: CGFloat) -> CGAffineTransform {
    zoom(scaleX: 0.7, scaleY: 0.7, x: x, y: y)
  }
  ...
  @objc open func isInBoundsX(_ x: CGFloat) -> Bool {
    isInBoundsLeft(x) && isInBoundsRight(x)
  }

  @objc open func isInBoundsY(_ y: CGFloat) -> Bool {
    isInBoundsTop(y) && isInBoundsBottom(y)
  }
  ...
  @objc open func isInBounds(point: CGPoint) -> Bool {
    isInBounds(x: point.x, y: point.y)
  }
  ...
  @objc open var hasNoDragOffset: Bool {
    _transOffsetX <= 0.0 && _transOffsetY <= 0.0
  }
