...
open class RadarChartView: PieRadarChartViewBase {
  ...
  override open var chartYMax: Double { _yAxis._axisMaximum }

  /// The minimum value this chart can display on it's y-axis.
  override open var chartYMin: Double { _yAxis._axisMinimum }

  /// The range of y-values this chart can display.
  @objc open var yRange: Double { _yAxis.axisRange }
}
