...
open class HorizontalBarHighlighter: BarHighlighter {
  ...
  override internal func buildHighlights(dataSet set: ChartDataSetProtocol,
                                         dataSetIndex: Int,
                                         xValue: Double,
  ...
  override internal func getDistance(x1: CGFloat, y1: CGFloat, x2: CGFloat, y2: CGFloat) -> CGFloat
  {
    abs(y1 - y2)
  }
}
