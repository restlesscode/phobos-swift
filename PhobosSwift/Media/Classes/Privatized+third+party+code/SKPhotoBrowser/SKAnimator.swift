...
extension SKAnimator {
  private func presentAnimation(_ browser: SKPhotoBrowser, completion: (() -> Void)? = nil) {
    let finalFrame = finalImageViewFrame
    browser.view.isHidden = true
  ...
  private func dismissAnimation(_ browser: SKPhotoBrowser, completion: (() -> Void)? = nil) {
    let finalFrame = senderViewOriginalFrame
