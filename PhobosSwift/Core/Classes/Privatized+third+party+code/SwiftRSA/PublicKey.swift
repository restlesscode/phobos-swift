...
public class PublicKey: Key {
    ...
    /// Takes an input string, scans for public key sections,
    /// and then returns a PublicKey for any valid keys found
    ...
    public static func publicKeys(pemEncoded pemString: String) -> [PublicKey] {
        ...
        guard let publicKeyRegexp = publicKeyRegex, !pemString.isEmpty else {
            return []
        }
