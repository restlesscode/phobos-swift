...
extension ObservableType where Element: NotificationEmitter {
  @available(*, deprecated, renamed: "collection(from:synchronousStart:)")
  public static func from(_ collection: Element, scheduler: ImmediateSchedulerType = CurrentThreadScheduler.instance) -> Observable<Element> {
   ...
   */
  public static func collection(from collection: Element, synchronousStart: Bool = true, on queue: DispatchQueue? = nil)
    -> Observable<Element> {
  ...
  public static func arrayFrom(_ collection: Element, scheduler: ImmediateSchedulerType = CurrentThreadScheduler.instance) -> Observable<[Element.ElementType]> {
   ...
   */
  public static func array(from collection: Element, synchronousStart: Bool = true, on queue: DispatchQueue? = nil)
  ...
  public static func changesetFrom(_ collection: Element, scheduler: ImmediateSchedulerType = CurrentThreadScheduler.instance) -> Observable<(AnyRealmCollection<Element.ElementType>, RealmChangeset?)> {
   ...
   */
  public static func changeset(from collection: Element, synchronousStart: Bool = true, on queue: DispatchQueue? = nil)
  ...
  public static func changesetArrayFrom(_ collection: Element, scheduler: ImmediateSchedulerType = CurrentThreadScheduler.instance) -> Observable<([Element.ElementType], RealmChangeset?)> {
   ...
   */
  public static func arrayWithChangeset(from collection: Element, synchronousStart: Bool = true, on queue: DispatchQueue? = nil)
