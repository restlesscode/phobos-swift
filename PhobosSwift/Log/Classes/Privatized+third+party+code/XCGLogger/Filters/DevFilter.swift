...
open class DevFilter: UserInfoFilter {
  ...
  ///
  override public init<S: Sequence>(includeFrom devs: S) where S.Iterator.Element == String {
  ...
  ///     - devs: Set or Array of devs to match against.
  ///
  override public init<S: Sequence>(excludeFrom devs: S) where S.Iterator.Element == String {
