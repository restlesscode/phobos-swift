...
open class TagFilter: UserInfoFilter {
  ...
  ///
  override public init<S: Sequence>(includeFrom tags: S) where S.Iterator.Element == String {
  ...
  ///     - tags: Set or Array of tags to match against.
  ///
  override public init<S: Sequence>(excludeFrom tags: S) where S.Iterator.Element == String {
