...
open class XCGLogger: CustomDebugStringConvertible {
  ...
  public static let `default` = XCGLogger(identifier: XCGLogger.Constants.defaultInstanceIdentifier)
  ...
  public static let logQueue = DispatchQueue(label: XCGLogger.Constants.logQueueIdentifier, attributes: [])
  ...
  open func setup(level: Level = .debug, showLogIdentifier: Bool = false, showFunctionName: Bool = true, showThreadName: Bool = false, showLevel: Bool = true, showFileNames: Bool = true, showLineNumbers: Bool = true, showDate: Bool = true, writeToFile: Any? = nil, fileLevel: Level? = nil) {
    ...
    if let writeToFile: Any = writeToFile {
      ...
      let standardFileDestination = FileDestination(writeToFile: writeToFile, identifier: XCGLogger.Constants.fileDestinationIdentifier)
  ...
  open func logln(_ level: Level = .debug, functionName: String = #function, fileName: String = #file, lineNumber: Int = #line, userInfo: [String: Any] = [:], closure: () -> Any?) {
    ...
    var _message = String(describing: closureResult)
    var _context = "context"
    if let result = closureResult as? (message: String, context: String) {
      _message = result.message
      _context = result.context
    }

    let logDetails = LogDetails(level: level, date: Date(), message: _message, context: _context, functionName: functionName, fileName: fileName, lineNumber: lineNumber, userInfo: userInfo)
  ...
  open func logAppDetails(selectedDestination: DestinationProtocol? = nil) {
    ...
    logDetails.append(LogDetails(level: .info, date: date, message: "\(processInfo.processName) \(buildString)PID: \(processInfo.processIdentifier)", context: "", functionName: "", fileName: "", lineNumber: 0, userInfo: XCGLogger.Constants.internalUserInfo))
    logDetails.append(LogDetails(level: .info, date: date, message: "XCGLogger Version: \(XCGLoggerVersionNumber) - Level: \(outputLevel)", context: "", functionName: "", fileName: "", lineNumber: 0, userInfo: XCGLogger.Constants.internalUserInfo))
  ...
  /// - Returns:  Nothing.
  ///
  class func verbose(_ functionName: StaticString = #function, fileName: StaticString = #file, lineNumber: Int = #line, userInfo: [String: Any] = [:]) {
  ...
  /// - Returns:  Nothing.
  ///
  class func verbose(_ closure: @autoclosure () -> Any?, functionName: StaticString = #function, fileName: StaticString = #file, lineNumber: Int = #line, userInfo: [String: Any] = [:]) {
  ...
  /// - Returns:  Nothing.
  ///
  class func verbose(_ functionName: StaticString = #function, fileName: StaticString = #file, lineNumber: Int = #line, userInfo: [String: Any] = [:], closure: () -> Any?) {
    self.default.logln(.verbose, functionName: functionName, fileName: fileName, lineNumber: lineNumber, userInfo: userInfo, closure: closure)
  }
  ...
  /// - Returns:  Nothing.
  ///
  class func debug(_ functionName: StaticString = #function, fileName: StaticString = #file, lineNumber: Int = #line, userInfo: [String: Any] = [:]) {
  ...
  /// - Returns:  Nothing.
  ///
  class func debug(_ closure: @autoclosure () -> Any?, functionName: StaticString = #function, fileName: StaticString = #file, lineNumber: Int = #line, userInfo: [String: Any] = [:]) {
  ...
  /// - Returns:  Nothing.
  ///
  class func debug(_ functionName: StaticString = #function, fileName: StaticString = #file, lineNumber: Int = #line, userInfo: [String: Any] = [:], closure: () -> Any?) {
    self.default.logln(.debug, functionName: functionName, fileName: fileName, lineNumber: lineNumber, userInfo: userInfo, closure: closure)
  }
  ...
  open func notice(_ functionName: StaticString = #function, fileName: StaticString = #file, lineNumber: Int = #line, userInfo: [String: Any] = [:]) {
    logln(.notice, functionName: functionName, fileName: fileName, lineNumber: lineNumber, userInfo: userInfo, closure: noMessageClosure)
  }
  ...
  open func notice(_ closure: @autoclosure () -> Any?, functionName: StaticString = #function, fileName: StaticString = #file, lineNumber: Int = #line, userInfo: [String: Any] = [:]) {
    logln(.notice, functionName: functionName, fileName: fileName, lineNumber: lineNumber, userInfo: userInfo, closure: closure)
  }
  ...
  open func alert(_ functionName: StaticString = #function, fileName: StaticString = #file, lineNumber: Int = #line, userInfo: [String: Any] = [:]) {
    logln(.alert, functionName: functionName, fileName: fileName, lineNumber: lineNumber, userInfo: userInfo, closure: noMessageClosure)
  }
  ...
  open func alert(_ closure: @autoclosure () -> Any?, functionName: StaticString = #function, fileName: StaticString = #file, lineNumber: Int = #line, userInfo: [String: Any] = [:]) {
    logln(.alert, functionName: functionName, fileName: fileName, lineNumber: lineNumber, userInfo: userInfo, closure: closure)
  }
  ...
  open func emergency(_ functionName: StaticString = #function, fileName: StaticString = #file, lineNumber: Int = #line, userInfo: [String: Any] = [:]) {
    logln(.emergency, functionName: functionName, fileName: fileName, lineNumber: lineNumber, userInfo: userInfo, closure: noMessageClosure)
  }
  ...
  open func emergency(_ closure: @autoclosure () -> Any?, functionName: StaticString = #function, fileName: StaticString = #file, lineNumber: Int = #line, userInfo: [String: Any] = [:]) {
    logln(.emergency, functionName: functionName, fileName: fileName, lineNumber: lineNumber, userInfo: userInfo, closure: closure)
  }
  ...
  /// - Returns:  Nothing.
  ///
  open class func noticeExec(_ closure: () -> Void = {}) {
  ...
  /// - Returns:  Nothing.
  ///
  open func noticeExec(_ closure: () -> Void = {}) {
    exec(XCGLogger.Level.notice, closure: closure)
  }
  ...
  /// - Returns:  Nothing.
  ///
  open class func alertExec(_ closure: () -> Void = {}) {
  ...
  /// - Returns:  Nothing.
  ///
  open func alertExec(_ closure: () -> Void = {}) {
    exec(XCGLogger.Level.alert, closure: closure)
  }
  ...
  /// - Returns:  Nothing.
  ///
  open class func emergencyExec(_ closure: () -> Void = {}) {
  ...
  /// - Returns:  Nothing.
  ///
  open func emergencyExec(_ closure: () -> Void = {}) {
    exec(XCGLogger.Level.emergency, closure: closure)
  }
  ...
  internal func _logln(_ message: String, level: Level = .debug, source sourceDestination: DestinationProtocol? = nil) {
    let logDetails = LogDetails(level: level, date: Date(), message: message, context: "", functionName: "", fileName: "", lineNumber: 0, userInfo: XCGLogger.Constants.internalUserInfo)
