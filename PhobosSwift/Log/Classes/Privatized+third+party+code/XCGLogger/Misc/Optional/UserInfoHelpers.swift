...
public struct Tag: UserInfoTaggingProtocol {
  ...
  public var dictionary: [String: String] {
    [XCGLogger.Constants.userInfoKeyTags: name]
  }
...
public struct Dev: UserInfoTaggingProtocol {
  ...
  /// Dictionary representation compatible with the userInfo paramater of log messages
  public var dictionary: [String: String] {
    [XCGLogger.Constants.userInfoKeyDevs: name]
  }
...
public func | <Key: Any, Value: Any>(lhs: [Key: Value], rhs: [Key: Value]) -> [Key: Any] {
  var mergedDictionary: [Key: Any] = lhs
...
public func |(lhs: UserInfoTaggingProtocol, rhs: UserInfoTaggingProtocol) -> [String: Any] {
  lhs.dictionary | rhs.dictionary
}

/// Overloaded operator, converts UserInfoTaggingProtocol types to dictionaries and then merges them
public func |(lhs: UserInfoTaggingProtocol, rhs: [String: Any]) -> [String: Any] {
  lhs.dictionary | rhs
}

/// Overloaded operator, converts UserInfoTaggingProtocol types to dictionaries and then merges them
public func |(lhs: [String: Any], rhs: UserInfoTaggingProtocol) -> [String: Any] {
  rhs.dictionary | lhs
}
